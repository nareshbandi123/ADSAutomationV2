...
using ADSAutomationV1Phase1Part3.Preconditions;
using ADSAutomationV1Phase1Part3.TC_10557;
using Ranorex;
using Ranorex.Core;
...
namespace ADSAutomationPhaseII.TC_10557
{
    public static class Steps
    {
		...
		public static void ClickOnSettingIcon()
		{
			try
			{
				repo.ChartPropertiesWindow.SettingTabInfo.WaitForItemExists(10000);
		...
		public static void ClickOnHighlight()
		{
			try
			{
				repo.DisplayWindow.HighlightButtonInfo.WaitForItemExists(30000);
				repo.DisplayWindow.HighlightButton.ClickThis();
