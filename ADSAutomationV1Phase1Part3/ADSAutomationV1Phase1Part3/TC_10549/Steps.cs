...
using ADSAutomationV1Phase1Part3.TC_10549;
using Ranorex;
using Ranorex.Core;
...
namespace ADSAutomationPhaseII.TC_10549
{
	public class Steps
	{
		...
		public static void SearchButton()
		{
			try
			{
				repo.ObjectSearchWindow.SearchButtonInfo.WaitForItemExists(30000);
		...
		public static void OracleSearchButton()
		{
			try
			{
				repo.ObjectSearchWindow.SearchButtonInfo.WaitForItemExists(30000);
			...
			{
				throw new Exception("Failed : OracleSearchButton : " + ex.Message);
			}
		}
		...
		public static void OracleAppendButton()
		{
			try
			{
				repo.ObjectSearchWindow.AppendButtonInfo.WaitForItemExists(30000);
				repo.ObjectSearchWindow.AppendButton.ClickThis();
				Reports.ReportLog("OracleAppendButton", Reports.ADSReportLevel.Success, null, Configuration.Config.TestCaseName);
		...
		public static void QuickFilter()
		{
			try
			{
				repo.ObjectSearchWindow.QuickFilterInfo.WaitForExists(new Duration(30000));
		...
		public static void Close()
		{
			try
			{
				repo.ObjectSearchWindow.CloseInfo.WaitForItemExists(30000);
		...
		public static void UnSelectViews()
		{
			try
			{
				repo.ObjectSearchWindow.UnSelectViewsInfo.WaitForExists(new Duration(30000));
		...
		public static void CloseConnectionOk()
		{
			try
			{
				if(repo.ObjectSearchWindow.CloseConnectionOKInfo.Exists(5000))
				{
					repo.ObjectSearchWindow.CloseConnectionOK.ClickThis();
				}
				Reports.ReportLog("CloseConnectionOk", Reports.ADSReportLevel.Success, null, Configuration.Config.TestCaseName);
			}
			catch(Exception ex)
			{
				throw new Exception("Failed : CloseConnectionOk : " + ex.Message);
			}
		}
