...
namespace ADSAutomationV1Phase1Part3.TC_10549
{
...
#region Variables
    ...
    public partial class TC10549Folders
    {
        ...
        public partial class ObjectSearchWindowAppFolder : RepoGenBaseFolder
        {
            ...
            RepoItemInfo _closeconnectionokInfo;
                    ...
                    base("ObjectSearchWindow", "/form[@title~'^Object\\ Search\\ \\[']", parentFolder, 30000, null, true, "c4bb506f-ec69-4e16-8bda-bedde83a647e", "")
            {
                ...
                _closeconnectionokInfo = new RepoItemInfo(this, "CloseConnectionOK", ".//container[@name='OptionPane.buttonArea']/button[@text='OK']", 30000, null, "364c310f-4c6f-4883-9562-77855adb37a4");
            }
            ...
            /// <summary>
            /// The CloseConnectionOK item.
            /// </summary>
            [RepositoryItem("364c310f-4c6f-4883-9562-77855adb37a4")]
            public virtual Ranorex.Button CloseConnectionOK
            {
                get
                {
                    return _closeconnectionokInfo.CreateAdapter<Ranorex.Button>(true);
                }
            }

            /// <summary>
            /// The CloseConnectionOK item info.
            /// </summary>
            [RepositoryItemInfo("364c310f-4c6f-4883-9562-77855adb37a4")]
            public virtual RepoItemInfo CloseConnectionOKInfo
            {
                get
                {
                    return _closeconnectionokInfo;
                }
            }
        }
