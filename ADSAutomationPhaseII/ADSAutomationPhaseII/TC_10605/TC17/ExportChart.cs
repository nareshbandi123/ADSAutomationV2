...
namespace ADSAutomationPhaseII.TC_10605.TC17
{
    
    [TestModule("7C428D35-43A8-440A-9C8A-130758E339C0", ModuleType.UserCode, 1)]
     ...
     public class ExportChart : BaseClass, ITestModule
	{
        ...
        bool StartProcess()
		{
			try
			{
				...
				Steps.ClickonNextAndSaveFile("Worksheet_TC17");
				Steps.ClickonClosePDFFile();
				Steps.CloseVisualizationwindow();
				Steps.Cleanup("Worksheet_TC17");
		}
			catch (Exception ex)
			{
				Steps.CloseVisualizationwindow();
