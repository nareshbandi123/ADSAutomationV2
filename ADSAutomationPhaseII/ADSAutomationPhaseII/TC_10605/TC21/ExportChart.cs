...
namespace ADSAutomationPhaseII.TC_10605.TC21
{
    
    [TestModule("6EDABA86-AF3E-457E-8852-758D6BC38A10", ModuleType.UserCode, 1)]
    ...
    public class ExportChart : BaseClass, ITestModule
	{
        ...
        bool StartProcess()
		{
			try
			{
				...
				Steps.ClickonNextAndSaveFile("Worksheet_TC21");
				Steps.ClickonClosePDFFile();
				Steps.CloseVisualizationwindow();
				Steps.Cleanup("Worksheet_TC21");
