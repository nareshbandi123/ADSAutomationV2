...
namespace ADSAutomationPhaseII.TC_10605.TC20
{
    
    [TestModule("AE01538E-8F0D-464A-8403-16B40225BCAB", ModuleType.UserCode, 1)]
    ...
    public class ExportChart : BaseClass, ITestModule
	{
        ...
        bool StartProcess()
		{
			try
			{
				...
				Steps.ClickonNextAndSaveFile("Worksheet_TC20");
				Steps.ClickonClosePDFFile();
				Steps.CloseVisualizationwindow();
				Steps.Cleanup("Worksheet_TC20");
