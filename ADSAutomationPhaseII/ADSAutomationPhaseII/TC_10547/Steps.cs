	...
	public static class Steps
	{
		...
		public static void ExecuteTC2()
		{
			try 
			{
				...
				Preconditions.Steps.SelectedServerTreeItem.ExpandAll();
				
				Preconditions.Steps.SelectedServerTreeItem.CollapseAll();
		...
		public static void ExecuteTC3(bool isAlter = false)
		{
			try 
			{
				...
				if(tablesItem != null)
				{
					...
					repo.Application.CreateNewTable.TableNameTextboxInfo.WaitForItemExists(120000);
		...
		public static void ExecuteTC5()
		{
			try 
			{
				...
				if(viewItem != null)
				{
					...
					repo.Application.CreateView.ViewNameTextboxInfo.WaitForItemExists(120000);
		...
		public static void ExecuteTC6()
		{
			try 
			{
				...
				if(triggerItem != null)
				{
					...
					if(repo.SQLFailed.SelfInfo.Exists(new Duration(2000))) { repo.SQLFailed.OkButton.ClickThis(); repo.Application.Triggers.CancelButton.ClickThis(); repo.DiscardTrigger.DiscardButton.ClickThis();}
					Reports.ReportLog("Create ads_trigger", Reports.ADSReportLevel.Success, null, Config.TestCaseName);
		...
		public static void ExecuteTC9()
		{
			try 
			{
				...
				tc10538Repo.UntitledApplication.QATextEditorInfo.WaitForItemExists(120000);
		...
		public static void ExecuteTC11()
		{
			try 
			{
				...
				Keyboard.Press(Keyboard.ToKey("Ctrl+A"), Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
				Keyboard.Press(Keyboard.ToKey("Delete"), Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
				tc10538Repo.UntitledApplication.QATextEditor.PressKeys(query1);
				Keyboard.Press(Keyboard.ToKey("Ctrl+A"), Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
				Preconditions.Steps.ClickQARun();
				System.Threading.Thread.Sleep(2000);
				Preconditions.Steps.CloseTab(Config.TestCaseName);
				...
				Keyboard.Press(Keyboard.ToKey("Ctrl+A"), Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
				Keyboard.Press(Keyboard.ToKey("Delete"), Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
				tc10538Repo.UntitledApplication.QATextEditor.PressKeys(query2);
				Keyboard.Press(Keyboard.ToKey("Ctrl+A"), Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
				Preconditions.Steps.ClickQARun();
				System.Threading.Thread.Sleep(2000);
				Preconditions.Steps.CloseTab(Config.TestCaseName);
