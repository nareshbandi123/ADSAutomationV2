...
using ADSAutomationV1Phase1Part1.TC_10540;
using Ranorex;
using Ranorex.Core;
...
namespace ADSAutomationPhaseII.TC_10540
{
	public static class Steps
	{
		...
		public static void SelectObjects()
		{
			try
			{
				foreach (var row in repo.ERGenerator.SelectObjects.Rows)
				{
					if(row.Cells[3].Text.ToLower() == "ads_table")
					{
						row.Cells[1].ClickThis();
				...
				Reports.ReportLog("SelectObjects", Reports.ADSReportLevel.Success, null, Config.TestCaseName);
			}
			catch (Exception ex)
			{
				repo.ERGenerator.Self.Close();
				throw new Exception("Failed : SelectObjects :" + ex.Message);
			}
		}
		...
		public static void SelectAquafold()
		{
			try
			{
				...
				TreeItem aquafold = SelectedServer.GetItem(Configuration.Config.AQUAFOLD, false);
				aquafold.Select();
		...
		public static void UnSelectObjects()
		{
			try
			{
				repo.ERGenerator.UnselectObjectsInfo.WaitForItemExists(30000);
				repo.ERGenerator.UnselectObjects.ClickThis();
				Reports.ReportLog("UnSelectObjects", Reports.ADSReportLevel.Success, null, Config.TestCaseName);
			}
			catch (Exception ex)
			{
				repo.ERGenerator.Self.Close();
