...
namespace ADSAutomationPhaseIII.Extensions
{
	public static class Extension
	{
		...
		public static void RightClickThis(this Ranorex.Row item)
		{
			try
			{
				item.RightClick();
		...
		public static void RightClickThis(this Ranorex.Cell item)
		{
			try
			{
				item.RightClick();
		...
		public static void RightClick(this Ranorex.Row item)
		{
			try 
			{
				Mouse.Click(item,System.Windows.Forms.MouseButtons.Right, new Point(30, 10));
		...
		public static void RightClick(this Ranorex.TabPage item)
		{
			try 
			{
				Mouse.Click(item,System.Windows.Forms.MouseButtons.Right, new Point(30, 10));
		...
		public static void SelectTab(this Ranorex.Container item, string TabName)
		{
			try 
			{
				var tabpage = item.Find<Ranorex.TabPage>(@".//container[@name='_sheetsPane']/tabpage");
				foreach (Ranorex.TabPage tab in tabpage) 
				{
					if(tab.Title.ToString().Contains(TabName))
					{
						tab.EnsureVisible();
						tab.Select();
					}
			...
			{
				throw new Exception("Select Tab Failed : " + ex.Message);
			}
		}
...
        } 
		...
		public static void CheckboxCheck(this Ranorex.CheckBox item)
		{
			try
			{
				if(!item.Checked)
			...
			{
				throw new Exception("CheckBox check Failed : " + ex.Message);
			}
		}
		
		public static void CheckboxUnCheck(this Ranorex.CheckBox item)
		{
			try
			{
				if(item.Checked)
		...
		public static void SetElementSelectedItemTextProperty(this Ranorex.Adapter ObjEle, string strValue)
		{
			try
			{
				ObjEle.Element.SetAttributeValue("selecteditemtext", strValue);
			}
			catch (Exception ex)
			{
				throw new Exception("Failed : SetElementSelectedItemTextProperty" +ex.Message);
			}
		}
		
		
		public static void RightClickThis(this Ranorex.Text item)
		{
			try
			{
				item.RightClick();
		...
		public static void RightClickThis(this Ranorex.WebElement item)
		{
			try 
			{
				item.Click();
			...
			{
				throw new Exception("WebElement Click Failed : " + ex.Message);
			}
		}
		
		
		public static void ClickThis(this Ranorex.WebElement item)
		{
			try 
			{
				item.Click();
		...
		public static void RightClickThis(this Ranorex.TabPage item)
		{
			try
			{
				item.RightClick();
